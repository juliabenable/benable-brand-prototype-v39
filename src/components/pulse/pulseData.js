...
export const TIMELINES = {
  Maya: [
    ...
    { when: 'Jul 24', detail: 'Delivered — shoot confirmed for Saturday' },
  ...
  Nia: [
    ...
    { when: 'Jul 19', detail: 'Picked Mineral Glow SPF 30 · shipped next day' },
    { when: 'Jul 24', detail: 'Delivered — she teased a BTS story' },
  ...
  Sofia: [
    ...
    { when: 'Jul 24', detail: 'Delivered — angle confirmed with Katie’s team' },
  ...
  Jade: [
    ...
    { when: 'Jul 21', detail: 'Picked SPF 50 Tinted · tracking in hand' },
  ...
  Priya: [
    ...
    { when: 'Jul 22', detail: 'Picked After-Sun Serum · shipped same day' },
    { when: 'Jul 24', detail: 'Delivered — filming window through Sunday' },
  ...
  Amara: [
    ...
    { next: 'Delivery — express tracking', detail: 'Delivered — shoot scheduled this week' },
